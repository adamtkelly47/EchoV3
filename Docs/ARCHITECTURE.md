...
echo/
    ...
    domains/
        ...
        system/         # populated Phase 24: models, schemas, errors, policies, repository,
                         ...
                         # application/orchestrators/monitoring.py
    providers/
