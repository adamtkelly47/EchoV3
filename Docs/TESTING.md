...
docker exec echo-devcheck mypy apps scripts core infrastructure migrations domains
docker exec echo-devcheck python scripts/check_size_limits.py apps core infrastructure domains
docker exec echo-devcheck python scripts/check_architecture.py .
docker exec echo-devcheck vulture apps core infrastructure domains scripts
docker exec echo-devcheck bandit -r apps core infrastructure domains -c pyproject.toml
